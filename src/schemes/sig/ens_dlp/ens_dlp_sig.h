...
#define ENS_DLP_SIG_USE_SINGLE_PREC_FLOATS
//#define ENS_DLP_SIG_USE_EFFICIENT_GAUSSIAN_SAMPLING
//#define ENS_DLP_SIG_GAUSSIAN_SAMPLE_MW_BOOTSTRAP
...
/// Sign a message of m_len bytes and incorporate the message into the signature for size efficiency
SINT32 ens_dlp_sig_sign_recovery(safecrypto_t *sc, UINT8 **m, size_t *m_len,
    UINT8 **sigret, size_t *siglen);

/// Verify a message (with recovery) of m_len bytes
