...
bliss_set_t param_bliss_b_0 = {
    ...
    {38, 140}, 11, 5, 100.0f, 2.44f, CRYPTO_HASH_SHA3_512,
...
bliss_set_t param_bliss_b_1 = {
    ...
    {0, 154}, 12, 3, 215.0f, 1.21f, CRYPTO_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
...
bliss_set_t param_bliss_b_2 = {
    ...
    {0, 154}, 12, 2, 107.0f, 2.18f, CRYPTO_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
...
bliss_set_t param_bliss_b_3 = {
    ...
    {16, 216}, 12, 3, 250.0f, 1.40f, CRYPTO_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
...
bliss_set_t param_bliss_b_4 = {
    ...
    {31, 231}, 12, 4, 271.0f, 1.61f, CRYPTO_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
