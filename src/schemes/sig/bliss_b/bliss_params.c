...
bliss_set_t param_bliss_b_0 = {
    ...
    {38, 140}, 3, 11, 5, 100.0f, 0.5f, 2.44f, SC_HASH_SHA3_512,
...
bliss_set_t param_bliss_b_1 = {
    ...
    {0, 154}, 2, 12, 3, 215.0f, 0.4792f, 1.21f, SC_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
...
bliss_set_t param_bliss_b_2 = {
    ...
    {0, 154}, 2, 12, 2, 107.0f, 0.4352f, 2.18f, SC_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
...
bliss_set_t param_bliss_b_3 = {
    ...
    {16, 216}, 3, 12, 3, 250.0f, 0.6460f, 1.40f, SC_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
...
bliss_set_t param_bliss_b_4 = {
    ...
    {31, 231}, 3, 12, 4, 271.0f, 0.625f, 1.61f, SC_HASH_SHA3_512,
#ifdef USE_RUNTIME_NTT_TABLES
    NULL, NULL, NULL, NULL, NULL
#else
    w12289_n512, r12289_n512, rev_w12289_n512, inv_w12289_n512, inv_r7681_n256
