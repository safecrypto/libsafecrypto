...
typedef void (*ntt32_center_32)(SINT32 *, size_t, const ntt_params_t*);
typedef void (*ntt32_normalize_32)(SINT32 *, size_t, const ntt_params_t*);
typedef void (*ntt32_center_16)(SINT16 *, size_t, const ntt_params_t*);
typedef void (*ntt32_normalize_16)(SINT16 *, size_t, const ntt_params_t*);
...
typedef struct _utils_arith_ntt {
    ...
    ntt32_flip              flip_32;
    ntt32_center_32         center_32;
    ntt32_normalize_32      normalize_32;
    ntt32_center_16         center_16;
    ntt32_normalize_16      normalize_16;
